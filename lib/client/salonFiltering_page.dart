...
class _SalonFilterPageState extends State<SalonFilterPage> {
  ...
  bool _isLoadingPopularService = false; // Loading state for popular services
  ...
  Future<void> _fetchSalonsWithPopularService() async {
    ...
    for (var salonDoc in salonSnapshot.docs) {
      ...
      if (reviewsSnapshot.docs.isNotEmpty) {
        ...
        salonResults.add({
          'salonName': salonDoc['salon_name'],
          'popularService': popularService,
          'imageUrl': salonDoc['image_url'] ?? '',
        });
      }
    }
    ...
    setState(() {
      ...
      _isLoadingPopularService = false;
    });
  }
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
                  ...
                  SizedBox(
                    ...
                    child: DropdownButtonFormField<String>(
                      ...
                      onChanged: (value) {
                        ...
                        // Automatically fetch based on the dropdown and search term
              ...
              SizedBox(
                height: 200,
                child: _isLoadingPopularService
                    ? const Center(child: CircularProgressIndicator())
                    : ListView.builder(
                        scrollDirection: Axis.horizontal,
